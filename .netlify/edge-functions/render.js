...
function localStorageStore(key2, initialValue, options) {
  ...
  function updateStorage(key22, value) {
    if (!browser)
      return;
    getStorage(storageType).setItem(key22, serializer.stringify(value));
  }
  if (!stores[key2]) {
    const store = writable(initialValue, (set2) => {
      const json2 = browser ? getStorage(storageType).getItem(key2) : null;
      if (json2) {
...
var stores, storePrefersDarkScheme, storeLightSwitch, icons, cBase$1, SvgIcon, cBase, cLead, cCenter, cTrail, AppBar, cBaseAppShell, cContentArea, cPage, cSidebarLeft, cSidebarRight, AppShell, cTrack, cThumb, cIcon, LightSwitch, css$1, Sidebar, css, Layout;
var init_layout_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_layout.svelte.js"() {
    ...
    cBase$1 = "inline-block outline-none";
    SvgIcon = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      classesBase = `${cBase$1} ${fill} ${width} ${height}`;
      return `
<svg xmlns="${"http://www.w3.org/2000/svg"}"${add_attribute("x", x, 0)}${add_attribute("y", y, 0)}${add_attribute("viewBox", viewBox, 0)} class="${"svg-icon " + escape(classesBase, true) + " " + escape($$props.class ?? "", true)}" focusable="${"false"}" data-testid="${"svg-icon"}">${title ? `<title>${escape(title)}</title>` : ``}${$$slots.default ? `${slots.default ? slots.default({}) : ``}` : `<path${add_attribute("d", icons[name].path, 0)}></path>`}</svg>`;
    ...
    cBase = "flex items-center";
    cLead = "flex-none flex justify-between items-center";
    cCenter = "flex-auto";
    cTrail = "flex-none flex items-center space-x-4";
    ...
    cPage = "flex-1 overflow-x-hidden overflow-y-auto flex flex-col";
...
<div class="${"lightswitch " + escape(classesBase, true)}" role="${"switch"}" aria-label="${"Light Switch"}"${add_attribute("aria-checked", $storeLightSwitch, 0)} title="${"Toggle " + escape($storeLightSwitch ? "Light" : "Dark", true) + " Mode"}" tabindex="${"0"}">
    ...
    css$1 = {
      code: ".modal-overlay.svelte-lxhk39{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0, 0, 0, 0.5);z-index:10;display:flex;flex-direction:column;justify-content:center}aside.svelte-lxhk39{position:fixed;top:0;right:0;height:100%;padding:2rem 1rem 0.6rem;border-left:1px solid \r\n  #000;overflow-y:auto;width:350px;z-index:100}",
      map: null
    };
    Sidebar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${show ? `<div class="${"modal-overlay svelte-lxhk39"}"></div>
     <aside class="${"text-black dark:text-white bg-[#aaa] dark:bg-black svelte-lxhk39"}"><button class="${"text-4xl"}">\xD7
        </button>
     <h1>Menu</h1></aside>` : ``}`;
    });
    css = {
      code: ".layout{width:100%}@media(min-width: 640px){.layout{max-width:640px}}@media(min-width: 768px){.layout{max-width:768px}}@media(min-width: 1024px){.layout{max-width:1024px}}@media(min-width: 1280px){.layout{max-width:1280px}}@media(min-width: 1536px){.layout{max-width:1536px}}.layout{margin-left:auto;margin-right:auto;display:flex;height:100%;align-items:center;justify-content:center}.modal-overlay{position:fixed;top:0;left:0;right:0;bottom:0;background:rgba(0, 0, 0, 0.5);z-index:10;display:flex;flex-direction:column;justify-content:center}aside{position:fixed;top:0;right:0;height:100%;padding:2rem 1rem 0.6rem;border-left:1px solid #aaa;background:#fff;overflow-y:auto;width:350px;z-index:100}",
      map: null
    };
...
${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
          default: () => {
            return `${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
              default: () => {
                return `<nav class="${"grid grid-cols-2 md:grid-cols-4 items-center text-xl px-[8%] py-2 w-[100vw]"}"><div class="${""}"><a class="${"text-2xl font-black "}" href="${"/"}">My cute kittens</a></div>
	
	
	<div class="${"hidden md:flex md:justify-evenly md:col-span-2"}"><a href="${"/about"}">About</a>
		<a href="${"/kittens"}">Kittens</a>
		<a href="${"/resources"}">Resources</a></div>
	
	<div class="${"flex justify-end items-center md:hidden"}">${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}
	<button><i class="${"fa-solid text-3xl ml-4 fa-bars"}"></i></button></div>
	<div class="${"hidden md:flex items-center md:justify-end "}">${validate_component(LightSwitch, "LightSwitch").$$render($$result, {}, {}, {})}
		<a href="${"/contact"}" class="${"btn ml-4 btn-filled-primary btn-base"}">Contact</a></div></nav>`;
              }
            })}
<div class="${"layout"}">${slots.default ? slots.default({}) : ``}</div>`;
          }
        })}`;
      } while (!$$settled);
      return $$rendered;
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    file = "_app/immutable/components/pages/_layout.svelte-de8bd3de.js";
    imports = ["_app/immutable/components/pages/_layout.svelte-de8bd3de.js", "_app/immutable/chunks/index-a51d240b.js", "_app/immutable/chunks/index-da6c5c8b.js"];
    stylesheets = ["_app/immutable/assets/_layout-caa25a66.css"];
    fonts = [];
  }
});
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    file2 = "_app/immutable/components/error.svelte-5d2654c1.js";
    imports2 = ["_app/immutable/components/error.svelte-5d2654c1.js", "_app/immutable/chunks/index-a51d240b.js", "_app/immutable/chunks/singletons-45a1b80e.js", "_app/immutable/chunks/index-da6c5c8b.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
var init_page_svelte = __esm({
  ".svelte-kit/output/server/entries/pages/_page.svelte.js"() {
    init_chunks();
    css2 = {
      code: ".layout.svelte-kwvzpb{width:100%\n}@media(min-width: 640px){.layout.svelte-kwvzpb{max-width:640px\n    }}@media(min-width: 768px){.layout.svelte-kwvzpb{max-width:768px\n    }}@media(min-width: 1024px){.layout.svelte-kwvzpb{max-width:1024px\n    }}@media(min-width: 1280px){.layout.svelte-kwvzpb{max-width:1280px\n    }}@media(min-width: 1536px){.layout.svelte-kwvzpb{max-width:1536px\n    }}.layout.svelte-kwvzpb{margin-left:auto;margin-right:auto;display:flex;height:100%;align-items:center;justify-content:center\n}",
      map: null
    };
    Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css2);
      return `<div class="${"h-screen w-screen layout svelte-kwvzpb"}"><div class="${"max-w-4xl px-4"}"><h1 class="${"text-6xl sm:text-7xl md:text-8xl font-black"}">Come adopt my <span class="${"text-primary-500"}">cute</span> ass <span class="${"text-tertiary-500"}">kittens</span></h1>
	<p class="${"prose-xl lg:prose-2xl mt-4"}">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam praesentium nesciunt eius nobis eos numquam rem inventore corrupti delectus quo.</p>
	
	<div class="${"mt-4 flex flex-col md:flex-row"}"><a href="${"/about"}" class="${"btn btn-filled-primary btn-base"}">Learn More</a>
		<span class="${"py-3 md:px-2"}"></span>
		<a href="${"/kittens"}" class="${"btn btn-filled-tertiary btn-base"}">To Cuteness</a></div></div>
</div>`;
    });
  }
});
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/2.js"() {
    ...
    file3 = "_app/immutable/components/pages/_page.svelte-b12e6c5f.js";
    imports3 = ["_app/immutable/components/pages/_page.svelte-b12e6c5f.js", "_app/immutable/chunks/index-a51d240b.js"];
    stylesheets3 = ["_app/immutable/assets/_page-f566d282.css"];
    fonts3 = [];
  }
});
...
var init_page_svelte2 = __esm({
  ".svelte-kit/output/server/entries/pages/about/_page.svelte.js"() {
    ...
    Page2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${"h-screen w-screen layout"}"><div class="${"px-4"}"><h1 class="${"text-6xl sm:text-7xl font-black"}">About us</h1>
...
Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt similique tempora asperiores enim doloribus esse?
    ...
    <div class="${"card card-hover card-glass-primary"}"><img src="${""}" alt="${""}"></div></div>`;
    });
  }
});
...
var init__4 = __esm({
  ".svelte-kit/output/server/nodes/3.js"() {
    ...
    file4 = "_app/immutable/components/pages/about/_page.svelte-f6b5692e.js";
    imports4 = ["_app/immutable/components/pages/about/_page.svelte-f6b5692e.js", "_app/immutable/chunks/index-a51d240b.js"];
    stylesheets4 = [];
    fonts4 = [];
  }
});
...
var init_page_svelte3 = __esm({
  ".svelte-kit/output/server/entries/pages/contact/_page.svelte.js"() {
    ...
    Page3 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<h1 class="${"text-7xl font-black"}">Contact us</h1>`;
    });
  }
});
...
var init__5 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    file5 = "_app/immutable/components/pages/contact/_page.svelte-462424bc.js";
    imports5 = ["_app/immutable/components/pages/contact/_page.svelte-462424bc.js", "_app/immutable/chunks/index-a51d240b.js"];
    stylesheets5 = [];
    fonts5 = [];
  }
});

// .svelte-kit/output/server/entries/pages/kittens/_page.svelte.js
var page_svelte_exports4 = {};
__export(page_svelte_exports4, {
  default: () => Page4
});
var cats, KittenCard, css3, Page4;
var init_page_svelte4 = __esm({
  ".svelte-kit/output/server/entries/pages/kittens/_page.svelte.js"() {
    init_chunks();
    cats = [
      { id: "1", name: "Filaberta", href: "filaberta", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "2", name: "Garfield", href: "garfield", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "3", name: "Pancake", href: "pancake", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "4", name: "Rocket", href: "rocket", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "5", name: "Bean", href: "bean", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "6", name: "Baby Bean", href: "babybean", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "7", name: "Baby Bean III", href: "babybeanjr", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "8", name: "Nice Kitty", href: "nicekitten", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "9", name: "Mean Kitten", href: "meankitten", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "10", name: "Fat Head", href: "fathead", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "11", name: "Bear", href: "bear", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "12", name: "Angel", href: "angel", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "13", name: "Baby Garfield", href: "babygarfield", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" },
      { id: "14", name: "Baby Bean the 4th", href: "babybeanfour", src: "https://images.unsplash.com/photo-1595433707802-6b2626ef1c91?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&w=1000&q=80" }
    ];
    KittenCard = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `${each(cats, (cat) => {
        return `<a href="${"/kittens/" + escape(cat.href, true)}"><div class="${"max-w-[275px] rounded hover:border-4 hover:border-primary-500 card mx-auto card-hover card-glass-surface"}"><img class="${"w-[275px] h-[250px] rounded-t cover "}"${add_attribute("src", cat.src, 0)} alt="${"kitten pic"}">
<div class="${"px-4 py-3"}"><h3 class="${"text-black dark:text-white font-bold"}">${escape(cat.name)}</h3>
 </div></div>
</a>`;
      })}`;
    });
    css3 = {
      code: ".layout.svelte-137jz3z{width:100%\n}@media(min-width: 640px){.layout.svelte-137jz3z{max-width:640px\n    }}@media(min-width: 768px){.layout.svelte-137jz3z{max-width:768px\n    }}@media(min-width: 1024px){.layout.svelte-137jz3z{max-width:1024px\n    }}@media(min-width: 1280px){.layout.svelte-137jz3z{max-width:1280px\n    }}@media(min-width: 1536px){.layout.svelte-137jz3z{max-width:1536px\n    }}.layout.svelte-137jz3z{margin-left:auto;margin-right:auto;display:flex;height:100%;align-items:center;justify-content:center\n}",
      map: null
    };
    Page4 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      $$result.css.add(css3);
      return `<section class="${"grid grid-cols-1 place-items-center h-screen layout svelte-137jz3z"}"><div class="${"px-4"}"><h1 class="${"text-7xl font-black"}">Let the cuteness beign...</h1>

    <div class="${"grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 mx-auto mt-6 gap-x-4 gap-y-6 "}">${validate_component(KittenCard, "KittenCard").$$render($$result, {}, {}, {})}</div></div>
</section>`;
    });
  }
});
...
var init__6 = __esm({
  ".svelte-kit/output/server/nodes/5.js"() {
    ...
    file6 = "_app/immutable/components/pages/kittens/_page.svelte-575f4a94.js";
    imports6 = ["_app/immutable/components/pages/kittens/_page.svelte-575f4a94.js", "_app/immutable/chunks/index-a51d240b.js"];
    stylesheets6 = ["_app/immutable/assets/_page-a02e459f.css"];
    fonts6 = [];
  }
});

// .svelte-kit/output/server/entries/pages/kittens/bean/_page.svelte.js
...
var init_page_svelte5 = __esm({
  ".svelte-kit/output/server/entries/pages/kittens/bean/_page.svelte.js"() {
    ...
    Page5 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${""}"><h1 class="${"text-7xl font-black"}">Bean</h1>
    <div class="${""}"><a class="${"no-underline"}" href="${"/kittens"}">Back</a>
...
var init__7 = __esm({
  ".svelte-kit/output/server/nodes/6.js"() {
    ...
    file7 = "_app/immutable/components/pages/kittens/bean/_page.svelte-40c99902.js";
    imports7 = ["_app/immutable/components/pages/kittens/bean/_page.svelte-40c99902.js", "_app/immutable/chunks/index-a51d240b.js"];
    stylesheets7 = [];
    fonts7 = [];
  }
});

// .svelte-kit/output/server/entries/pages/kittens/filaberta/_page.svelte.js
...
var init_page_svelte6 = __esm({
  ".svelte-kit/output/server/entries/pages/kittens/filaberta/_page.svelte.js"() {
    ...
    Page6 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${""}"><h1 class="${"text-7xl font-black"}">Filaberta</h1>
    <div class="${""}"><a class="${"no-underline"}" href="${"/kittens"}">Back</a>
        <a href="${"/contact"}">Contact us</a></div></div>`;
    });
  }
...
var init__8 = __esm({
  ".svelte-kit/output/server/nodes/7.js"() {
    ...
    file8 = "_app/immutable/components/pages/kittens/filaberta/_page.svelte-1725f52e.js";
    imports8 = ["_app/immutable/components/pages/kittens/filaberta/_page.svelte-1725f52e.js", "_app/immutable/chunks/index-a51d240b.js"];
    stylesheets8 = [];
    fonts8 = [];
  }
});

// .svelte-kit/output/server/entries/pages/kittens/garfield/_page.svelte.js
...
var init_page_svelte7 = __esm({
  ".svelte-kit/output/server/entries/pages/kittens/garfield/_page.svelte.js"() {
    ...
    Page7 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${""}"><h1 class="${"text-7xl font-black"}">Garfield</h1>
    <div class="${""}"><a class="${"no-underline"}" href="${"/kittens"}">Back</a>
        <a href="${"/contact"}">Contact us</a></div></div>`;
    });
  }
...
var init__9 = __esm({
  ".svelte-kit/output/server/nodes/8.js"() {
    ...
    file9 = "_app/immutable/components/pages/kittens/garfield/_page.svelte-0dc9c7eb.js";
    imports9 = ["_app/immutable/components/pages/kittens/garfield/_page.svelte-0dc9c7eb.js", "_app/immutable/chunks/index-a51d240b.js"];
    stylesheets9 = [];
    fonts9 = [];
  }
});

// .svelte-kit/output/server/entries/pages/kittens/pancake/_page.svelte.js
...
var init_page_svelte8 = __esm({
  ".svelte-kit/output/server/entries/pages/kittens/pancake/_page.svelte.js"() {
    ...
    Page8 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${""}"><h1 class="${"text-7xl font-black"}">Pancake</h1>
    <div class="${""}"><a class="${"no-underline"}" href="${"/kittens"}">Back</a>
        <a href="${"/contact"}">Contact us</a></div></div>`;
    });
  }
...
var init__10 = __esm({
  ".svelte-kit/output/server/nodes/9.js"() {
    ...
    file10 = "_app/immutable/components/pages/kittens/pancake/_page.svelte-d9e09856.js";
    imports10 = ["_app/immutable/components/pages/kittens/pancake/_page.svelte-d9e09856.js", "_app/immutable/chunks/index-a51d240b.js"];
    stylesheets10 = [];
    fonts10 = [];
  }
});

// .svelte-kit/output/server/entries/pages/kittens/rocket/_page.svelte.js
...
var init_page_svelte9 = __esm({
  ".svelte-kit/output/server/entries/pages/kittens/rocket/_page.svelte.js"() {
    ...
    Page9 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<div class="${""}"><h1 class="${"text-7xl font-black"}">Rocket</h1>
    <div class="${""}"><a class="${"no-underline"}" href="${"/kittens"}">Back</a>
        <a href="${"/contact"}">Contact us</a></div></div>`;
    });
  }
...
var init__11 = __esm({
  ".svelte-kit/output/server/nodes/10.js"() {
    ...
    file11 = "_app/immutable/components/pages/kittens/rocket/_page.svelte-f007ac9c.js";
    imports11 = ["_app/immutable/components/pages/kittens/rocket/_page.svelte-f007ac9c.js", "_app/immutable/chunks/index-a51d240b.js"];
    stylesheets11 = [];
    fonts11 = [];
  }
});
...
async function render_response({
  ...
  const fonts12 = new Set(options.manifest._.entry.fonts);
  ...
  if (page_config.ssr) {
    ...
    for (const { node } of branch) {
      ...
      if (node.fonts) {
        node.fonts.forEach((url) => fonts12.add(url));
      }
...
var manifest = {
  ...
  _: {
    entry: { "file": "_app/immutable/start-e057e131.js", "imports": ["_app/immutable/start-e057e131.js", "_app/immutable/chunks/index-a51d240b.js", "_app/immutable/chunks/singletons-45a1b80e.js", "_app/immutable/chunks/index-da6c5c8b.js"], "stylesheets": [], "fonts": [] },
    nodes: [
    ...
    routes: [
      ...
      {
        id: "/kittens/bean",
        pattern: /^\/kittens\/bean\/?$/,
        params: [],
        page: { layouts: [0], errors: [1], leaf: 6 },
        endpoint: null
      },
      {
        id: "/kittens/filaberta",
        pattern: /^\/kittens\/filaberta\/?$/,
        params: [],
...
function is_static_file(request) {
  ...
  return manifest.assets.has(file12) || manifest.assets.has(file12 + "/index.html") || prerendered.has(pathname || "/");
}
export {
  handler as default
};
